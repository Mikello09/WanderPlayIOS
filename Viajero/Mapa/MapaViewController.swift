...
class MapaViewController: BaseViewController, MGLMapViewDelegate{
    ...
    var popup: UIView?
    var verde: MGLSymbolStyleLayer?
    var azul: MGLSymbolStyleLayer?
    var amarillo: MGLSymbolStyleLayer?
    var naranja: MGLSymbolStyleLayer?
    var rojo: MGLSymbolStyleLayer?
    var visitado: MGLSymbolStyleLayer?
